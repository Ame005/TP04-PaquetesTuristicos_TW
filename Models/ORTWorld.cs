class ORTWorld{
    ...
    public static List<string> ListaHoteles {get;private set;} = new List<string> (){"sheraton.jpg","novotel.jpg","marriot.jpg","llaollao.jpg","ibis.jpg","iberostar.jpg","holidayInn.jpg","hilton.jpg","clubMed.jpg","4Seasons.jpg"};
    ...
    public static List<string> ListaExcursiones {get; private set;} = new List<string> (){"teatro.jpg","ski.jpg","helicoptero.jpg","museoVan.jpg","tirolesa.jpg","parqueAgua.jpg","buceo.jpg","ciclismo.jpg","canotaje.jpg","trekking.jpg"};
